...
# examines every pixel in the rectangle and circle. If both pixels
...
# A bitwise 'OR' examines every pixel in the rectangle and circle. If
# either pixel is greater than zero, then the output pixel has a value
# of 255, otherwise it is 0.
bitwiseOr = cv2.bitwise_or(rectangle, circle)
cv2.imshow("OR", bitwiseOr)
cv2.waitKey(0)

# The bitwise 'XOR' is identical th the 'OR' function, with one
...
# with a value of 255 become 0, and pixels witha value of 0 become
# 255.
